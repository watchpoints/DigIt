    ...
    def on_event(
        ...
        if dora_event["type"] == "INPUT":
            ...
            if dora_event["id"] in agent_inputs:
                ...
                send_output("llm_output", pa.array([create_agent_output(agent_name='llm_test', agent_result=agent_result,dataflow_status=os.getenv('IS_DATAFLOW_END',True))]),dora_event['metadata'])
